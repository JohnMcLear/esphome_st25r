...
git fetch --depth=1 upstream next
git checkout -b "$DOCS_BRANCH" upstream/next
...
- A component image can be generated by commenting: `@esphomebot generate image st25r`
- Documentation will be finalized once the component PR is reviewed and ready.
PR_BODY
)"
